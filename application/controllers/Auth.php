...
class Auth extends CI_Controller
{
	...
	public function lista(){
		...
		if (!$this->ion_auth->logged_in()){
			...
			// Queries mais complexas, como esta, podem ser úteis:
		    // $this->data['users'] = $this->ion_auth->where('company', '')->users()->result();
...
*/
		...
		else
		{
			...
			$this->data['email'] = [
				...
				'id' => 'email',
				'type' => 'email',
				'placeholder' => 'Obrigatório - seuemail@exemplo.com',
			...
			$this->data['password'] = [
				...
				'id' => 'password',
				'type' => 'password',
				'placeholder' => 'Obrigatório - Minímo de 8 caracteres',
