            ...
            <div class="row mt-4 font-weight-normal">
              <div class="col-md-10 mx-auto">
                <form method="POST"> 
                    ...
                    <div class="row">
                        <p class="col-lg-12">
                        <label for="nome">Nome Completo: </label><input class="form-control" value="<?= isset($user) ? $user['first_name'].' '.$user['last_name'] : ''; ?>" type="text" id="nome" name="nome" maxlenght="128" required readonly="readonly"/>
                        </p>
                        <p class="col-lg-6">
                        <label for="nasc" class="pt-4">Data de Nascimento: </label><input class="form-control" value="<?= isset($ficha) ? $ficha['data_nasc'] : ''; ?>" type="date" id="data_nasc" name="data_nasc" maxlenght="8" required/>
                        </p>
                        <p class="col-lg-6">
                        <label for="tel" class="pt-4">Telefone/Celular: </label><input class="form-control" value="<?= isset($user) ? $user['phone']: ''; ?>"  type="tel" id="telefone" name="telefone" maxlenght="11" required <?= $user['phone'] ? 'readonly="readonly"' : ''; ?>/>
                        </p>
                        <p class="col-lg-4">
                        <label for="cep" class="pt-4">CEP: </label><input class="form-control" value="<?= isset($ficha) ? $ficha['cep'] : ''; ?>" name="cep" id="cep" required/>
                        </p>
                        <p class="col-lg-4">
                        <label for="estado" class="pt-4">Estado: </label><input class="form-control" value="<?= isset($ficha) ? $ficha['estado'] : ''; ?>" name="estado" id="estado" data-autocomplete-state required/>
                        </p>	
                        <p class="col-lg-4">
                        <label for="numero" class="pt-4">Número: </label><input class="form-control" value="<?= isset($ficha) ? $ficha['numero'] : ''; ?>" name="numero" id="numero" type="number" required/>
                        </p>
                        <p class="col-lg-6">
                        <label for="bairro" class="pt-4">Bairro: </label><input class="form-control" value="<?= isset($ficha) ? $ficha['bairro'] : ''; ?>" name="bairro" id="bairro" data-autocomplete-neighborhood required/>
                        </p>
                        <p class="col-lg-6">
                        <label for="cidade" class="pt-4">Cidade: </label><input class="form-control" value="<?= isset($ficha) ? $ficha['cidade'] : ''; ?>" name="cidade" id="cidade" data-autocomplete-city required/>
                        </p>
                        <p class="col-lg-12">
                        <label for="end" class="pt-4">Endereço: </label><input class="form-control" type="text" value="<?= isset($ficha) ? $ficha['endereco'] : ''; ?>" id="endereco" name="endereco" maxlenght="256" data-autocomplete-address required/>
                        </p>
                    </div> 
                    <div class="row">
                        <h4 class="col-12 font-weight-bold ">Se menor:</h4>
                        <p class="col-lg-8">
                        <label for="responsavel" class="pt-4">Responsável: </label><input class="form-control" value="<?= isset($ficha) ? $ficha['resp_nome'] : ''; ?>" type="text" id="resp_nome" name="resp_nome" maxlenght="128"/>
                        </p>
                        <p class="col-lg-4">
                        <label for="tel_res" class="pt-4">Telefone/Celular: </label><input class="form-control" value="<?= isset($ficha) ? $ficha['fone'] : ''; ?>" type="tel" id="fone" name="fone" maxlenght="11"/>
                        </p>
                        <p class="col-lg-4">
                        <label for="cpf" class="pt-4">CPF: </label><input class="form-control" value="<?= isset($ficha) ? $ficha['cpf'] : ''; ?>" id="cpf" name="cpf"/>
                        </p>
                        <p class="col-lg-4">                     
                        <label for="rg" class="pt-4">RG: </label><input class="form-control" value="<?= isset($ficha) ? $ficha['rg'] : ''; ?>" id="rg" name="rg"/>
                        </p>
                        <p class="col-lg-4">
                        <label for="nasc_resp" class="pt-4">Data de Nascimento: </label><input class="form-control" value="<?= isset($ficha) ? $ficha['nasc_resp'] : ''; ?>" type="date" id="nasc_resp" name="nasc_resp" maxlenght="8"/>
                        </p>
                    </div>
                    ...
                    <div class="row mt-4"> 
                        ...
                        <textarea class="form-control" name="prob_out" id="prob_out"><?= isset($ficha) ? $ficha['prob_out'] : ''; ?></textarea>
                        ...
                        <p class="col-lg-8">
                        <label for="data_proc">Data do Procedimento: </label><input class="form-control" type="date" value="<?= isset($ficha) ? $ficha['data_proc'] : ''; ?>" id="data_proc" name="data_proc" maxlenght="8" required/>
                        </p>
                    </div>
                    ...
                    <div class="row mb-5">
                        ...
                        <p class="mb-4">A <b class="text-uppercase">durabilidade</b> da aplicação depende muito dos <b class="text-uppercase">cuidados da cliente</b>, que deverá seguir às <a href="<?= base_url('index.php/pages/recomendar'); ?>#recomendacoes" target="_blank"><b class="text-uppercase">recomendações</b></a>.</p>
                        <button type="submit" class="btn btn-primary mt-3 mx-auto">Salvar</button>
                    </div>
                </form>
              </div>
            </div>
